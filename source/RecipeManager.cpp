...
void RecipeManager::addAll() {
	centrifuge.emplace("Stone",      std::list<CentrifugeOutput> {{"", 0., 8.}, {"Silicon", 1., 1.}, {"Oxygen", 2., 1.}});
	centrifuge.emplace("Apple",      std::list<CentrifugeOutput> {{"", 0., 75.}, {"Malic Acid", 1., 25.}});
	...
	centrifuge.emplace("Wood",       std::list<CentrifugeOutput> {{"Cellulose", 1., 98.}, {"Lignin", 1., 2.}});
	...
	centrifuge.emplace("Water",      std::list<CentrifugeOutput> {{"", 0., 95.}, {"Yeast", 1., 5.}});
}
