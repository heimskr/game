...
class Keyboard {
	public:
		...
		static bool openForNumber(std::function<void(int)> f, const std::string &headerText = "", const std::string &subText = "", int maxStringLength = MAX_LENGTH, const std::string &initialText = "", const std::string &leftButton = "", const std::string &rightButton = "", u32 kbdDisableBitmask = 0);
